...
def configure_main_component(out_dir):
...
def main(out_dir):
    configure_main_component(out_dir)
...
if __name__ == '__main__':
    out_dir=''
    try:
        opts,args=getopt.getopt(sys.argv[1:],'hv',['zekra-dir=','adjlist-len=','adjlist-levels=','path-len=','stack-depth=','label-bitwidth=','bucket-bitwidth=','address-bitwidth=','output-dir=','components-dir='])
